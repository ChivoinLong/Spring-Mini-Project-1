(function ($) {
    ...
    $.fn.customSelect = function (options) {
        ...
        //$(document).on('click',function () { is_visible_default = false; });
        ...
        var ret = this.each(function () {
            ...
            this.custom = {
                ...
                createElems: function () {
                    var O = this;
                    O.E.wrap('<div class="customSelect" tabindex="0">');
                    O.select = O.E.parent();
                    O.caption = $('<span></span>');
                ...
                multiSelelect: function () {
                    ...
                    O.okbtn = $('<p class="btnOk">OK</p>').on('click', function () {
                    ...
                    O.cancelBtn = $('<p class="btnCancel">Cancel</p>').on('click', function () {
                        O._cnbtn();
                        O.hideOpts();
                    });
...
//                                O.hideOpts();
                    ...
                    if (O.is_floating) {
                        ...
                        if (O.is_multi)
                            H = H + parseInt(O.optDiv.css('padding-bottom'), 10);
                ...
                basicEvents: function () {
                    ...
                    $(window).on('resize.custom', function () {
                        O.floatingList();
                    });
                },
                ...
                reload: function () {
                    var elm = this.unload();
                    return $(elm).customSelect(settings);
                },
                unload: function () {
                    var O = this;
                    O.select.before(O.E);
                ...
                //## Enables the control
                enable: function () {
                    return this.toggcustom(false)
                },
                //## Disables the control
                disable: function () {
                    return this.toggcustom(true)
                },
                init: function () {
                    var O = this;
                    O.createElems();
